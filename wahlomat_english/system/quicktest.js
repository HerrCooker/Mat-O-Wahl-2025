...
*/
	...
	if (counterError > 0)
	{
		$("#testOtherDe").append("<br /> Bitte &uuml;berpr&uuml;fen Sie Ihre <a href='data/definition_english.js' target='_blank'>Einstellungen</a>.")
			.append("<br />")
			.css("color","red");
		$("#testOtherEn").append("<br /> Please check your <a href='data/definition_english.js' target='_blank'>settings</a>.")
			.append("<br />")
			.css("color","red");			
	}
	else
