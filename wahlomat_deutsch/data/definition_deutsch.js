...
const descriptionHeading1 = "StuPa Wahl";
...
const imprintGeneral = '<div class="entry-content wp-block-post-content has-global-padding is-layout-constrained wp-block-post-content-is-layout-constrained">\n' +
	...
	'<p class="has-medium-font-size">Wahlauschuss des Studierendenparlaments<br>Universität Duisburg-Essen<br>Universitätsstraße 2<br>45141 Essen</p>\n' +
	'<h4 class="wp-block-heading">Vorsitz</h4>\n' +
	'<p class="has-medium-font-size">Pascal Winter und Timon Rhein</p>\n' +
...
/*const imprintPictures = `<p> Bilder mit freundlicher Genehmigung von den jeweiligen Listen.`;*/
